...
NORMAL_SERVERS = [Server('192.168.1.55', 13412), Server('192.168.1.70', 32142), Server('192.168.172.117', 14769), Server('192.168.172.117', 14769)]
NORMAL_SERVERS_FOR_CLIENT = [Server('192.168.1.55', 14760), Server('192.168.1.70', 14767), Server('192.168.172.117', 14769), Server('192.168.172.117', 14769)]
LOGIN_SERVER = Server('192.168.1.70', 12304)
LB_SERVER = Server('192.168.1.70', 12328)
